...
import backgroundImg from "../assets/images/back.jpeg";
import {
  TIE,
  PLAYER_1_WIN,
  PLAYER_2_WIN,
...
const useGame = () => {
  ...
  useEffect(() => {
    ...
    const { player1, player2, background, ctx } = initSprites();
  ...
  const animate = (params) => {
    const { player1, player2, background, ctx } = params;
    ...
    // player - 2
    if (
      rectangularCollision(player2, player1) &&
      player2.isAttacking &&
